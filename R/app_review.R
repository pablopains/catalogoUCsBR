    ...
    ui <- 
      {
        shinydashboard::dashboardPage(
          dashboardHeader(title = "Revisão Catálogo UCs BR"),
          ...
          dashboardSidebar(width = 230,
                           ...
                           sidebarMenu(
                             ...
                             menuItem("Manual para obtenção de dados", 
                                      icon = icon("book"), 
                                      href = "https://github.com/pablopains/catalogoUCsBR/blob/main/Manual_download_CatalogoUCsBR.pdf",
                                      newtab = TRUE),
                             menuItem("REFLORA", 
                                      icon = icon("link"), 
                                      href = "http://reflora.jbrj.gov.br/reflora/herbarioVirtual/ConsultaPublicoHVUC/ResultadoDaConsultaNovaConsulta.do",
                                    ...
                                    wellPanel(
                                      fluidRow(
                                        column(
                                          ...
                                          shiny::tags$div(
                                            title = "Informe o nome completo do especielista verificador",
                                            textInput("Ctrl_verificadoPor_Input", "Nome completo do especialista verificador:", Ctrl_identifiedBy)),
                                          
                                          shiny::tags$div(
                                            title = "Informe e-mail para controle (chave de controle para revisão).",
                                            textInput("Ctrl_emailVerificador_Input", "2. E-mail para controle de revisão:", Ctrl_emailVerificador)),
                                          
                                          # as.POSIXlt(Sys.time(), "GMT") # the current time in GMT
                                          shiny::tags$div(
                                            title = "Informe data da revisão.",
                                    ...
                                    wellPanel(
                                      fluidRow(
                                        column(width = 12,
                                               ...
                                               shiny::tags$div(
                                                 title = "Carregue arquivo CSV padronizado com registros de ocorrência para revisão",
                                      ...
                                      fluidRow(
                                        column(width = 12,
                                               ...
                                               actionButton("getUnvalidatedNamesBtn", "Carregar dados", 
                                                            title = "Carregar arquivo CSV com lista de ocorrências para validação",
                                                            icon = icon("play")),
                                               br(),
                                               br(),
                                        ))))
                           ...
                           wellPanel(
                             fluidRow(
                               column(
                                 width = 12,
                                 shiny::tags$div(
                                   title = "Selecionar família para revisão.",
                                   selectInput("Ctrl_familyList_Input", "Selecionar uma família para revisão:",
                                               Ctrl_familyList)),
                           ...
                           column(width = 12,
                                  ...
                                  box(title = "4. Selecionar espécime / Confirmar ou atribuir nova identificação",
                                                          ...
                                                          wellPanel(
                                                            fluidRow(
                                                              column(
                                                                width = 12,
                                                                shiny::tags$div(
                                                                  title = "Selecionar uma outra família",
                                                                  selectInput("Ctrl_new_familyList_Input", "Selecionar uma outra família:",
                                                                              Ctrl_FB2020_familyList)),
                                                                
                                                                shiny::tags$div(
                                                                  title = "Selecionar uma espécie.",
                                                                  selectInput("Ctrl_new_specie_Input", "Selecionar a espécie:",
                                                                              Ctrl_new_specieList)),
                                               ...
                                               wellPanel(
                                                 fluidRow(
                                                   column(
                                                     ...
                                                     helpText('Selecionar nome científico para confirmar ou atribuir nova identificação'),
                                                     
                                                     shiny::tags$div(
                                                       title = "Selecionar nome científico para confirmar ou atribuir nova identificação",
                                               ...
                                               wellPanel(
                                                 fluidRow(
                                                   column(
                                                     ...
                                                     actionButton("save_verified_namesBtn", "Salvar alterações", icon = icon("save"),
                                                                  title = "Salvar alterações no registro em tela"),
                                      ...
                                      fluidRow(
                                        column(width = 12,
                                               shiny::tags$div(
                                                 title = "Selecionar status taxonômico para listar nomes científicos",
                                                 selectInput(inputId = 'taxonomicStatus_FB2020',
                                                             label = 'Selecionar status taxonômico para listar nomes científicos:',
                                      ...
                                      fluidRow(
                                        column(
                                          ...
                                          downloadButton("downloadVerificacaoAmostra", "Baixar Planilha Completa para Revisão Eletrônica",
                                                         title = "Baixar Planilha Completa para Revisão Eletrônica."),
                                        ))
                                    ),
